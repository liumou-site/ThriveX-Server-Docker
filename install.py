...
if __name__ == "__main__":
    ...
    arg.add_argument('-P', '--port', default=3306, help='数据库端口,默认: 3306', dest='port')
    arg.add_argument('-p', '--password', default=None, help='数据库密码', dest='password')
    arg.add_argument('-u', '--username', default="thrive", help='数据库用户名,默认:thrive', dest='username')
    arg.add_argument('-d', '--dbname', default="ThriveX", help='数据库名称,默认: ThriveX', dest='dbname')
